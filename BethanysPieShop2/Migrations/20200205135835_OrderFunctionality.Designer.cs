...
namespace BethanysPieShop2.Migrations
{
    ...
    [Migration("20200205135835_OrderFunctionality")]
    partial class OrderFunctionality
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BethanysPieShop2.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("BethanysPieShop2.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("BethanysPieShop2.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("BethanysPieShop2.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BethanysPieShop2.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("BethanysPieShop2.Models.OrderDetail", b =>
                {
                    b.HasOne("BethanysPieShop2.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BethanysPieShop2.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BethanysPieShop2.Models.Pie", b =>
                {
                    b.HasOne("BethanysPieShop2.Models.Category", "Category")
                        .WithMany("Pies")
